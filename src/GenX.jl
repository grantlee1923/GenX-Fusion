...
include("load_inputs/load_fusion_data.jl")
...
include("model/resources/thermal/fusion.jl")
...
include("write_outputs/write_lorenz_curve.jl")
include("write_outputs/write_net_revenue.jl")
include("write_outputs/write_fusion.jl")
